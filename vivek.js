...
vivekmasonaDown.style.height="104.5%";
...
vivekmasonaDownDiv.style.background="rgba(0,0,0,.7)";
...
vivekmasonaDownDiv.style.borderRadius="0px";
...
vivekmasonaDownDiv.innerHTML+="<span style='position:absolute;top:4px;left:4px;color:#ffffff;font-size:25px;' onclick='"+"this.parentElement.parentElement.style.display="+'"'+"none"+'"'+";'>&#x2716;</span><iframe src='https://pgmoviepro.blogspot.com/' height='100%' width='100%' frameBorder='0px'></iframe><ul id='listurl'>";
...
vivekmasonaDownVidElem.innerHTML='	<svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-list-details" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="#04C5B9" stroke-linecap="round" stroke-linejoin="round"> <path stroke="none" d="M0 0h24v24H0z" fill="none"/> <path d="M13 5h8" /> <path d="M13 9h5" /> <path d="M13 15h8" /> <path d="M13 19h5" /> <rect x="3" y="4" width="6" height="6" rx="1" /> <rect x="3" y="14" width="6" height="6" rx="1" /> </svg>					<br><font color=#00cdb8><b>Updates';
...
vivekmasonaPIPVidElem.innerHTML='	<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" class="bi bi-pip" viewBox="0 0 16 16" id="IconChangeColor"> <path d="M0 3.5A1.5 1.5 0 0 1 1.5 2h13A1.5 1.5 0 0 1 16 3.5v9a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 12.5v-9zM1.5 3a.5.5 0 0 0-.5.5v9a.5.5 0 0 0 .5.5h13a.5.5 0 0 0 .5-.5v-9a.5.5 0 0 0-.5-.5h-13z" id="mainIconPathAttribute" fill="#000000" stroke="#04C5B9" stroke-width="0"></path> <path d="M8 8.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 .5.5v3a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5v-3z" id="mainIconPathAttribute" fill="#00cdb8" stroke="#000000"></path> </svg>						<br><font color=#00cdb8><b>[PIP] Mode ';
...
vivekmasonaAudX.style.background="rgba(0,0,0,.9)";
...
vivekmasonaAudX.style.color="#ffffff";
